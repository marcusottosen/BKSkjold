        ...
        item {
            ...
            { val firstName = remember { mutableStateOf(CurrentUser.firstName) }
                ...
                OutlinedTextField(modifier = Modifier.fillMaxWidth(),
                    ...
                    onValueChange = { input -> firstName.value = input ; registerViewModel.updateFirstName(input)},
                    singleLine = true,
        ...
        item {
            ...
            { val lastName = remember { mutableStateOf(CurrentUser.lastName) }
                ...
                OutlinedTextField(modifier = Modifier.fillMaxWidth(),
                    ...
                    onValueChange = { input -> lastName.value = input ; registerViewModel.updateLastName(input)},
                    singleLine = true,
                    keyboardOptions = KeyboardOptions(
                        keyboardType = KeyboardType.Text,
                        imeAction = ImeAction.Done),
        ...
        item {
                ...
                .padding(start = 20.dp, end = 20.dp))
            {
                ...
                OutlinedTextField(modifier = Modifier.fillMaxWidth(),
                    ...
                    value = eMail.value,
                    onValueChange = { input -> eMail.value = input; registerViewModel.updateEmail(input) },
                    singleLine = true,
                    keyboardOptions = KeyboardOptions(
